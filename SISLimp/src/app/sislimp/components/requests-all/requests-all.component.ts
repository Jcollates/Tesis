...
export class RequestsAllComponent implements OnInit {
  ...
  createCols() {
    this.cols = [
      ...
      { field: '', header: 'Productos solicitados' },
      { field: '', header: 'Confirmar productos' },
      { field: '', header: 'Aceptar solicitud' },
      { field: '', header: 'Rechazar solicitud' },
      { field: '', header: 'Poner en espera' },
      { field: '', header: 'Completar' },
    ]
    this.colsEmployees = [
  ...
  chargeData(event: LazyLoadEvent) {
    this.requetsService.getAllSolProducts().subscribe(rest => {
      console.log("requetsService", rest);
